...
class ButtonMenu(Button):
    def __init__(self, text='',  **kwargs):
        super().__init__(text, scale = (0.8,0.1),texture = "assets/blocks/Andesite_(texture)_JE3_BE2.png", texture_scale = (0.5, 0.5), parent=camera.ui, model= "quad", radius=0.1, origin=(0,0),  text_size=1, color= color.white, collider='box', highlight_scale=1, pressed_scale=1, **kwargs)
...
class Menu(Entity):
    def __init__(self, game, **kwargs):
        ...
        self.button1 = ButtonMenu(text = "Save")
